...
/// GetDefault200ResponseMetadata : Information about the request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDefault200ResponseMetadata {
    ...
    pub query: Option<Box<models::GetDefaultRequest>>,
...
impl GetDefault200ResponseMetadata {
    /// Information about the request
    pub fn new() -> GetDefault200ResponseMetadata {
