...
/// Json2DDestinations : The individual destinations of the matrix calculations.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct Json2DDestinations {
