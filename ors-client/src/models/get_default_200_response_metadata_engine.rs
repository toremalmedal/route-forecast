...
/// GetDefault200ResponseMetadataEngine : Information about the openrouteservice engine used
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDefault200ResponseMetadataEngine {
...
impl GetDefault200ResponseMetadataEngine {
    /// Information about the openrouteservice engine used
    pub fn new() -> GetDefault200ResponseMetadataEngine {
        GetDefault200ResponseMetadataEngine {
            version: None,
            build_date: None,
            graph_date: None,
            osm_date: None,
