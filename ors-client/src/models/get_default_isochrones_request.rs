...
/// GetDefaultIsochronesRequest : The JSON body request sent to the isochrones service which defines options and parameters regarding the isochrones to generate.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDefaultIsochronesRequest {
...
impl GetDefaultIsochronesRequest {
    ...
    pub fn new(locations: Vec<Vec<f64>>, range: Vec<f64>) -> GetDefaultIsochronesRequest {
