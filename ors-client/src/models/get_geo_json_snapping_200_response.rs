...
/// GetGeoJsonSnapping200Response : The GeoJSON Snapping Response contains the snapped coordinates in GeoJSON format.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetGeoJsonSnapping200Response {
    /// GeoJSON type
...
impl GetGeoJsonSnapping200Response {
    /// The GeoJSON Snapping Response contains the snapped coordinates in GeoJSON format.
    pub fn new() -> GetGeoJsonSnapping200Response {
        GetGeoJsonSnapping200Response {
            r#type: None,
            features: None,
            metadata: None,
            bbox: None,
