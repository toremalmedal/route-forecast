...
/// ProfileParametersRestrictions : Describe restrictions to be applied to edges on the routing. any edges that do not match these restrictions are not traversed.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProfileParametersRestrictions {
...
impl ProfileParametersRestrictions {
    ...
    pub fn new() -> ProfileParametersRestrictions {
