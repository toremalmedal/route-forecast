...
pub struct ElevationLinePost200Response {
    ...
    pub geometry: Option<Box<models::ElevationLinePost200ResponseGeometry>>,
}

impl ElevationLinePost200Response {
    pub fn new() -> ElevationLinePost200Response {
        ElevationLinePost200Response {
            attribution: None,
            version: None,
            timestamp: None,
            geometry: None,
