...
/// GetDefault1200ResponseSourcesInner : The individual sources of the matrix calculations.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDefault1200ResponseSourcesInner {
...
impl GetDefault1200ResponseSourcesInner {
    /// The individual sources of the matrix calculations.
    pub fn new() -> GetDefault1200ResponseSourcesInner {
