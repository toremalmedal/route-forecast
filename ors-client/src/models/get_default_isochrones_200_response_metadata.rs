...
/// GetDefaultIsochrones200ResponseMetadata : Information about the request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDefaultIsochrones200ResponseMetadata {
    ...
    pub query: Option<Box<models::GetDefaultIsochronesRequest>>,
...
impl GetDefaultIsochrones200ResponseMetadata {
    /// Information about the request
    pub fn new() -> GetDefaultIsochrones200ResponseMetadata {
