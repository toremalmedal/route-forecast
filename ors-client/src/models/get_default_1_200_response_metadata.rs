...
/// GetDefault1200ResponseMetadata : Information about the request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDefault1200ResponseMetadata {
    ...
    pub query: Option<Box<models::GetDefault1Request>>,
...
impl GetDefault1200ResponseMetadata {
    /// Information about the request
    pub fn new() -> GetDefault1200ResponseMetadata {
