...
pub struct ElevationPointGet200Response {
    ...
    pub geometry: Option<Box<models::ElevationPointGet200ResponseGeometry>>,
}

impl ElevationPointGet200Response {
    pub fn new() -> ElevationPointGet200Response {
        ElevationPointGet200Response {
            attribution: None,
            version: None,
            timestamp: None,
            geometry: None,
