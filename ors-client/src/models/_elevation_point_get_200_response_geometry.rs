...
pub struct ElevationPointGet200ResponseGeometry {
...
impl ElevationPointGet200ResponseGeometry {
    pub fn new() -> ElevationPointGet200ResponseGeometry {
        ElevationPointGet200ResponseGeometry {
            r#type: None,
            coordinates: None,
        }
    }
