...
/// GetDefault1200Response : The Matrix Response contains one matrix for each specified `metrics` value.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDefault1200Response {
...
impl GetDefault1200Response {
    /// The Matrix Response contains one matrix for each specified `metrics` value.
    pub fn new() -> GetDefault1200Response {
        GetDefault1200Response {
            durations: None,
            distances: None,
            destinations: None,
            sources: None,
