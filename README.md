...
endpoint that returns names and coords for places in Norway. Uses https://api.met.no/, https://api.openrouteservice.org/ and https://api.kartverket.no/stedsnavn/v1/.
