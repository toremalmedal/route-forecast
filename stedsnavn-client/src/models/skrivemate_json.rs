...
pub struct SkrivemateJson {
    ...
    #[serde(rename = "stedsnavnnummer", skip_serializing_if = "Option::is_none")]
    pub stedsnavnnummer: Option<i32>,
}

impl SkrivemateJson {
    pub fn new() -> SkrivemateJson {
        SkrivemateJson {
            navnestatus: None,
            skrivemte: None,
            skrivemtestatus: None,
            sprk: None,
            stedsnavnnummer: None,
        }
    }
}
