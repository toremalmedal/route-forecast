...
pub struct ReturSkrivemate {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::Metadata>>,
    #[serde(rename = "navn", skip_serializing_if = "Option::is_none")]
    pub navn: Option<Vec<models::Skrivemate>>,
}

impl ReturSkrivemate {
    pub fn new() -> ReturSkrivemate {
        ReturSkrivemate {
            metadata: None,
            navn: None,
        }
