...
pub struct Fylker {
    #[serde(rename = "fylkesnavn", skip_serializing_if = "Option::is_none")]
    pub fylkesnavn: Option<String>,
    #[serde(rename = "fylkesnummer", skip_serializing_if = "Option::is_none")]
    pub fylkesnummer: Option<String>,
}
